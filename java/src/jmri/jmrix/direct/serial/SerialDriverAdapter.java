...
public class SerialDriverAdapter extends PortController implements jmri.jmrix.SerialPortAdapter {
    ...
    public String openPort(String portName, String appName) {
        try {
            ...
            try {
                activeSerialPort.setSerialPortParams(17240, SerialPort.DATABITS_8, SerialPort.STOPBITS_1,
                ...
                try {
                    ...
                    activeSerialPort.setSerialPortParams(19200, SerialPort.DATABITS_8, SerialPort.STOPBITS_1,
                            SerialPort.PARITY_NONE);
