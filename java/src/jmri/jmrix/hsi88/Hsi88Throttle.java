 ...
 * 
 */
public class Hsi88Throttle extends AbstractThrottle implements Hsi88Listener {

    /**
     * Constructor.
     */
    public Hsi88Throttle(Hsi88SystemConnectionMemo memo, LocoAddress address) {
        super(memo);
        ...
        tc.sendHsi88Message(Hsi88Message.getQryLocoSpeed(getCANAddress()), this);
        tc.sendHsi88Message(Hsi88Message.getQryLocoDirection(getCANAddress()), this);
        for (int i = 0; i <= 28; i++) {
            tc.sendHsi88Message(Hsi88Message.getQryLocoFunction(getCANAddress(), i), this);
        }
    }
    ...
    protected void sendFunctionGroup1() {
        ...
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 0, (f0 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 1, (f1 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 2, (f2 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 3, (f3 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 4, (f4 ? 0x01 : 0x00)), this);
    ...
    protected void sendFunctionGroup2() {
        ...
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 5, (f5 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 6, (f6 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 7, (f7 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 8, (f8 ? 0x01 : 0x00)), this);

    }

    protected void sendFunctionGroup3() {

        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 9, (f9 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 10, (f10 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 11, (f11 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 12, (f12 ? 0x01 : 0x00)), this);

    }

    protected void sendFunctionGroup4() {

        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 13, (f13 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 14, (f14 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 15, (f15 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 16, (f16 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 17, (f17 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 18, (f18 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 19, (f19 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 20, (f20 ? 0x01 : 0x00)), this);

    }

    protected void sendFunctionGroup5() {

        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 21, (f21 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 22, (f22 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 23, (f23 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 24, (f24 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 25, (f25 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 26, (f26 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 27, (f27 ? 0x01 : 0x00)), this);
        tc.sendHsi88Message(Hsi88Message.setLocoFunction(getCANAddress(), 28, (f28 ? 0x01 : 0x00)), this);
    ...
    public void setSpeedSetting(float speed) {
        ...
        if (value < 0) {
            //Emergency Stop
            tc.sendHsi88Message(Hsi88Message.setLocoEmergencyStop(getCANAddress()), this);
        } else {
            tc.sendHsi88Message(Hsi88Message.setLocoSpeed(getCANAddress(), value), this);
        }
    ...
    /**
     * Convert a Hsi88 speed integer to a float speed value
     */
    ...
    public void setIsForward(boolean forward) {
        ...
        tc.sendHsi88Message(Hsi88Message.setLocoDirection(getCANAddress(), (forward ? 0x01 : 0x02)), this);
        if (old != isForward) {
        ...
        switch (address.getProtocol()) {
            case DCC:
                if (Mode == DccThrottle.SpeedStepMode28 && isLong) {
                    tc.sendHsi88Message(Hsi88Message.setLocoSpeedSteps(getCANAddress(), Hsi88Constants.STEPLONG28), this);
                } else if (Mode == DccThrottle.SpeedStepMode28 && !isLong) {
                    tc.sendHsi88Message(Hsi88Message.setLocoSpeedSteps(getCANAddress(), Hsi88Constants.STEPSHORT28), this);
                } else if (Mode == DccThrottle.SpeedStepMode128 && isLong) {
                    tc.sendHsi88Message(Hsi88Message.setLocoSpeedSteps(getCANAddress(), Hsi88Constants.STEPLONG128), this);
                } else if (Mode == DccThrottle.SpeedStepMode128 && !isLong) {
                    tc.sendHsi88Message(Hsi88Message.setLocoSpeedSteps(getCANAddress(), Hsi88Constants.STEPSHORT128), this);
                }
                break;
            default:
    ...
    public void reply(Hsi88Reply m) {
        if (m.getPriority() == Hsi88Constants.PRIO_1 && m.getCommand() >= Hsi88Constants.MANCOMMANDSTART && m.getCommand() <= Hsi88Constants.MANCOMMANDEND) {
            ...
            if (m.getCommand() == Hsi88Constants.LOCODIRECTION) {
                if (log.isDebugEnabled()) {
            ...
            if (m.getCommand() == Hsi88Constants.LOCOSPEED) {
            ...
            if (m.getCommand() == Hsi88Constants.LOCOFUNCTION) {
    ...
    int getCANAddress() {
        switch (address.getProtocol()) {
            case DCC:
                return Hsi88Constants.DCCSTART + address.getNumber();
            case MOTOROLA:
                return address.getNumber();
            case SELECTRIX:
                return Hsi88Constants.SX2START + address.getNumber();
            case MFX:
                return Hsi88Constants.MFXSTART + address.getNumber();
            default:
                return Hsi88Constants.DCCSTART + address.getNumber();
        }
    }
    ...
    // initialize logging
    private final static Logger log = LoggerFactory.getLogger(Hsi88Throttle.class.getName());
