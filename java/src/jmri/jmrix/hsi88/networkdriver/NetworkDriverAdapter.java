package jmri.jmrix.hsi88.networkdriver;
...
/**
 * Implements SerialPortAdapter for the Hsi88 system network connection.
 * <P>
 * This connects an Hsi88 command station via a UDP connection. Normally
 * controlled by the NetworkDriverFrame class.
 *
 * @author	Bob Jacobsen Copyright (C) 2001, 2002, 2003, 2008
 * @author	Kevin Dickerson Copyright (C) 2012
 */
public class NetworkDriverAdapter extends Hsi88PortController implements jmri.jmrix.NetworkPortAdapter {
    ...
    public NetworkDriverAdapter() {
        ...
        manufacturerName = jmri.jmrix.hsi88.Hsi88ConnectionTypeList.MARKLIN;
        m_port = 15731;
    }
    ...
    public void configure() {
        ...
        Hsi88TrafficController control = new Hsi88TrafficController();
